    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(requests ->
                requests
                        ...
                        .requestMatchers("/api/v1/stock-movements/supplier-order/{supplierOrderId}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER)
                        .requestMatchers("/api/v1/stock-movements/client-order/{clientOrderId}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER)
                        .requestMatchers("/api/v1/stock-movements/sale/{saleId}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER)
                        .requestMatchers("/api/v1/stock-movements/{id}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/all").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/in").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/out").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/article/{articleId}/in").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/article/{articleId}/out").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/article/{articleId}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/article/{articleId}/total-in").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/article/{articleId}/total-out").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/recent").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/type/{type}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/origin/{origin}").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES)
                        .requestMatchers("/api/v1/stock-movements/create/**").hasAnyRole(ROLE_ADMIN, ROLE_MANAGER)
                        .requestMatchers("/api/v1/stock-movements/**").hasRole(ROLE_ADMIN)
